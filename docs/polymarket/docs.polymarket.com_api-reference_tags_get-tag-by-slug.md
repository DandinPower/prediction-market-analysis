...
[Get tag by id\\
\\
Previous](https://docs.polymarket.com/api-reference/tags/get-tag-by-id) [Get related tags (relationships) by tag id\\
\\
Next](https://docs.polymarket.com/api-reference/tags/get-related-tags-relationships-by-tag-id)
