---
url: "https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user"
title: "Get recent transactions for a user - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#content-area)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#parameter-poly-builder-api-key)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#parameter-poly-builder-timestamp)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#parameter-poly-builder-passphrase)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#parameter-poly-builder-signature)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#parameter-relayer-api-key)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#parameter-relayer-api-key-address)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-transaction-id)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-transaction-hash)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-from)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-to)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-proxy-address)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-data)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-nonce)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-value)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-signature)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-state)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-type)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-owner)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-metadata)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-created-at)
...
[​](https://docs.polymarket.com/api-reference/relayer/get-recent-transactions-for-a-user#response-items-updated-at)
...
\\
Previous](https://docs.polymarket.com/api-reference/relayer/get-a-transaction-by-id) [Get current nonce for a user\\
\\
Next](https://docs.polymarket.com/api-reference/relayer/get-current-nonce-for-a-user)
