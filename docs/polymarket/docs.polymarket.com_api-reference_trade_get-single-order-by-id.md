---
url: "https://docs.polymarket.com/api-reference/trade/get-single-order-by-id"
title: "Get single order by ID - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#content-area)
...
polyApiKey & polyAddress & polySignature & polyPassphrase & polyTimestamppolyBuilderApiKey & polyBuilderPassphrase & polyBuilderSignature & polyBuilderTimestamppolyApiKey & polyAddress & polySignature & polyPassphrase & polyTimestamppolyBuilderApiKey & polyBuilderPassphrase & polyBuilderSignature & polyBuilderTimestamp

[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#authorization-poly-api-key)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#authorization-poly-address)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#authorization-poly-signature)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#authorization-poly-passphrase)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#authorization-poly-timestamp)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#parameter-order-id)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-id)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-status)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-owner)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-maker-address)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-market)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-asset-id)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-side)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-original-size)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-size-matched)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-price)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-outcome)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-expiration)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-order-type)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-created-at)
...
[​](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id#response-associate-trades)
...
[Cancel single order\\
\\
Previous](https://docs.polymarket.com/api-reference/trade/cancel-single-order) [Post multiple orders\\
\\
Next](https://docs.polymarket.com/api-reference/trade/post-multiple-orders)
