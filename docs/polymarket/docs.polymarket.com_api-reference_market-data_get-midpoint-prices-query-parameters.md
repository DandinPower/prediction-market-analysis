...
title: "Get midpoint prices (query parameters) - Polymarket Documentation"
---
...
[Get midpoint price\\
\\
Previous](https://docs.polymarket.com/api-reference/data/get-midpoint-price) [Get midpoint prices (request body)\\
\\
