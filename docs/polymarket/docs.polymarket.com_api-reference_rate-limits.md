...
title: "Rate Limits - Polymarket Documentation"
---
...
- [General](https://docs.polymarket.com/api-reference/rate-limits#general)
- [Gamma API](https://docs.polymarket.com/api-reference/rate-limits#gamma-api)
- [Data API](https://docs.polymarket.com/api-reference/rate-limits#data-api)
- [CLOB API](https://docs.polymarket.com/api-reference/rate-limits#clob-api)
- [General](https://docs.polymarket.com/api-reference/rate-limits#general-2)
- [Market Data](https://docs.polymarket.com/api-reference/rate-limits#market-data)
- [Ledger](https://docs.polymarket.com/api-reference/rate-limits#ledger)
- [Authentication](https://docs.polymarket.com/api-reference/rate-limits#authentication)
- [Trading](https://docs.polymarket.com/api-reference/rate-limits#trading)
- [Other](https://docs.polymarket.com/api-reference/rate-limits#other)
- [Next Steps](https://docs.polymarket.com/api-reference/rate-limits#next-steps)
...
## [​](https://docs.polymarket.com/api-reference/rate-limits\#general)  General
...
## [​](https://docs.polymarket.com/api-reference/rate-limits\#gamma-api)  Gamma API
...
## [​](https://docs.polymarket.com/api-reference/rate-limits\#data-api)  Data API
...
## [​](https://docs.polymarket.com/api-reference/rate-limits\#clob-api)  CLOB API

Base URL: `https://clob.polymarket.com`

### [​](https://docs.polymarket.com/api-reference/rate-limits\#general-2)  General
...
### [​](https://docs.polymarket.com/api-reference/rate-limits\#market-data)  Market Data
...
### [​](https://docs.polymarket.com/api-reference/rate-limits\#ledger)  Ledger
...
### [​](https://docs.polymarket.com/api-reference/rate-limits\#authentication)  Authentication

| Endpoint | Limit |
| --- | --- |
| API key endpoints | 100 req / 10s |

### [​](https://docs.polymarket.com/api-reference/rate-limits\#trading)  Trading
...
## [​](https://docs.polymarket.com/api-reference/rate-limits\#other)  Other
...
## [​](https://docs.polymarket.com/api-reference/rate-limits\#next-steps)  Next Steps
...
[Authentication\\
\\
Previous](https://docs.polymarket.com/api-reference/authentication) [Clients & SDKs\\
\\
Next](https://docs.polymarket.com/api-reference/clients-sdks)
