...
title: "Get last trade price - Polymarket Documentation"
---
...
[Get spreads\\
\\
Previous](https://docs.polymarket.com/api-reference/market-data/get-spreads) [Get last trade prices (query parameters)\\
\\
