...
\\
Previous](https://docs.polymarket.com/api-reference/tags/get-related-tags-relationships-by-tag-id) [Get tags related to a tag id\\
\\
Next](https://docs.polymarket.com/api-reference/tags/get-tags-related-to-a-tag-id)
