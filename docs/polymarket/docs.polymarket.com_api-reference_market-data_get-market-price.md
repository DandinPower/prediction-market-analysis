---
url: "https://docs.polymarket.com/api-reference/market-data/get-market-price"
...
\\
Previous](https://docs.polymarket.com/api-reference/market-data/get-order-books-request-body) [Get market prices (query parameters)\\
\\
