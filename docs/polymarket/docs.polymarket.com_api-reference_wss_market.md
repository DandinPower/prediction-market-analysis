...
[Skip to main content](https://docs.polymarket.com/api-reference/wss/market#content-area)
...
Best bid and ask price update — requires custom\_feature\_enabled: true
...
New market creation event — requires custom\_feature\_enabled: true
...
Market resolution event — requires custom\_feature\_enabled: true
...
\\
Previous](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys) [User Channel\\
\\
Next](https://docs.polymarket.com/api-reference/wss/user)
