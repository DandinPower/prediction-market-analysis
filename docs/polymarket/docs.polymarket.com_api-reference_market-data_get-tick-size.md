---
url: "https://docs.polymarket.com/api-reference/market-data/get-tick-size"
title: "Get tick size - Polymarket Documentation"
---
...
\\
Previous](https://docs.polymarket.com/api-reference/market-data/get-fee-rate-by-path-parameter) [Get tick size by path parameter\\
\\
Next](https://docs.polymarket.com/api-reference/market-data/get-tick-size-by-path-parameter)
