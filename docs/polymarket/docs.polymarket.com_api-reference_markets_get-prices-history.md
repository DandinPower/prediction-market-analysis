...
title: "Get prices history - Polymarket Documentation"
---
...
\\
Previous](https://docs.polymarket.com/api-reference/market-data/get-last-trade-prices-request-body) [Get fee rate\\
\\
Next](https://docs.polymarket.com/api-reference/market-data/get-fee-rate)
