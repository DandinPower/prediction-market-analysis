...
\\
Previous](https://docs.polymarket.com/api-reference/bridge/get-transaction-status) [Submit a transaction\\
\\
Next](https://docs.polymarket.com/api-reference/relayer/submit-a-transaction)
