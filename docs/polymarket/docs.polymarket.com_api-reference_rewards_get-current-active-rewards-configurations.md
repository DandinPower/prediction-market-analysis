...
title: "Get current active rewards configurations - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/rewards/get-current-active-rewards-configurations#content-area)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-current-active-rewards-configurations#parameter-sponsored)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-current-active-rewards-configurations#parameter-next-cursor)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-current-active-rewards-configurations#response-limit)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-current-active-rewards-configurations#response-count)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-current-active-rewards-configurations#response-next-cursor)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-current-active-rewards-configurations#response-data)
...
\\
Previous](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker) [Get raw rewards for a specific market\\
\\
Next](https://docs.polymarket.com/api-reference/rewards/get-raw-rewards-for-a-specific-market)
