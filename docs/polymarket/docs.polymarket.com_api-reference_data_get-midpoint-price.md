---
url: "https://docs.polymarket.com/api-reference/data/get-midpoint-price"
...
\\
Previous](https://docs.polymarket.com/api-reference/market-data/get-market-prices-request-body) [Get midpoint prices (query parameters)\\
\\
