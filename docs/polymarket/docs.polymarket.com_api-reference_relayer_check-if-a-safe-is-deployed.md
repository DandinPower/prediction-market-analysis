---
url: "https://docs.polymarket.com/api-reference/relayer/check-if-a-safe-is-deployed"
title: "Check if a safe is deployed - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/relayer/check-if-a-safe-is-deployed#content-area)
...
[​](https://docs.polymarket.com/api-reference/relayer/check-if-a-safe-is-deployed#parameter-address)
...
[​](https://docs.polymarket.com/api-reference/relayer/check-if-a-safe-is-deployed#response-deployed)
...
\\
Previous](https://docs.polymarket.com/api-reference/relayer/get-relayer-address-and-nonce) [Get all relayer API keys\\
\\
Next](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys)
