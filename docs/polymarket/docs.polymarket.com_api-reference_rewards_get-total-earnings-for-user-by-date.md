---
url: "https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date"
title: "Get total earnings for user by date - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#content-area)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#authorization-poly-api-key)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#authorization-poly-address)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#authorization-poly-signature)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#authorization-poly-passphrase)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#authorization-poly-timestamp)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#parameter-date)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#parameter-signature-type)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#parameter-maker-address)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#parameter-sponsored)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#response-items-date)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#response-items-asset-address)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#response-items-maker-address)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#response-items-earnings)
...
[​](https://docs.polymarket.com/api-reference/rewards/get-total-earnings-for-user-by-date#response-items-asset-rate)
...
\\
Previous](https://docs.polymarket.com/api-reference/rewards/get-earnings-for-user-by-date) [Get reward percentages for user\\
\\
Next](https://docs.polymarket.com/api-reference/rewards/get-reward-percentages-for-user)
