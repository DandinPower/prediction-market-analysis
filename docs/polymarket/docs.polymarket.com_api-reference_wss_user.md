---
url: "https://docs.polymarket.com/api-reference/wss/user"
title: "User Channel - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/wss/user#content-area)
...
Authenticated subscription message sent after connecting
...
Subscribe or unsubscribe from markets without reconnecting
...
Trade match, confirmation, or status change
...
[Market Channel\\
\\
Previous](https://docs.polymarket.com/api-reference/wss/market) [Sports Channel\\
\\
Next](https://docs.polymarket.com/api-reference/wss/sports)
