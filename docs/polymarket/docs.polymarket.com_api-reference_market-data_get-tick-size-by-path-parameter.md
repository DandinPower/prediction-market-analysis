---
url: "https://docs.polymarket.com/api-reference/market-data/get-tick-size-by-path-parameter"
title: "Get tick size by path parameter - Polymarket Documentation"
---
...
[Get tick size\\
\\
Previous](https://docs.polymarket.com/api-reference/market-data/get-tick-size) [Get server time\\
\\
Next](https://docs.polymarket.com/api-reference/data/get-server-time)
