---
url: "https://docs.polymarket.com/api-reference/trade/post-multiple-orders"
title: "Post multiple orders - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#content-area)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#authorization-poly-api-key)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#authorization-poly-address)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#authorization-poly-signature)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#authorization-poly-passphrase)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#authorization-poly-timestamp)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#body-items-order)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#body-items-owner)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#body-items-order-type)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#body-items-defer-exec)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#response-items-success)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#response-items-order-id)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#response-items-status)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#response-items-making-amount)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#response-items-taking-amount)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#response-items-transactions-hashes)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#response-items-trade-ids)
...
[​](https://docs.polymarket.com/api-reference/trade/post-multiple-orders#response-items-error-msg)
...
\\
Previous](https://docs.polymarket.com/api-reference/trade/get-single-order-by-id) [Get user orders\\
\\
Next](https://docs.polymarket.com/api-reference/trade/get-user-orders)
