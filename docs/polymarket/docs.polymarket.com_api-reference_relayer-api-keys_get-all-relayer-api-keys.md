---
url: "https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys"
title: "Get all relayer API keys - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys#content-area)
...
[​](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys#parameter-relayer-api-key)
...
[​](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys#parameter-relayer-api-key-address)

RELAYER\_API\_KEY\_ADDRESS

string

Address that owns the key (when using relayer API key auth). Must match the address that owns the key.
...
[​](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys#response-items-api-key)
...
[​](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys#response-items-address)
...
[​](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys#response-items-created-at)
...
[​](https://docs.polymarket.com/api-reference/relayer-api-keys/get-all-relayer-api-keys#response-items-updated-at)
...
\\
Previous](https://docs.polymarket.com/api-reference/relayer/check-if-a-safe-is-deployed) [Market Channel\\
\\
Next](https://docs.polymarket.com/api-reference/wss/market)
