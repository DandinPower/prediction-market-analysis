...
\\
Previous](https://docs.polymarket.com/api-reference/search/search-markets-events-and-profiles) [Get tag by id\\
\\
Next](https://docs.polymarket.com/api-reference/tags/get-tag-by-id)
