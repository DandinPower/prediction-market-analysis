...
\\
Previous](https://docs.polymarket.com/api-reference/sports/get-valid-sports-market-types) [Get supported assets\\
\\
Next](https://docs.polymarket.com/api-reference/bridge/get-supported-assets)
