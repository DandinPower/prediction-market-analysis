---
url: "https://docs.polymarket.com/api-reference/relayer/get-relayer-address-and-nonce"
title: "Get relayer address and nonce - Polymarket Documentation"
---
...
\\
Previous](https://docs.polymarket.com/api-reference/relayer/get-current-nonce-for-a-user) [Check if a safe is deployed\\
\\
Next](https://docs.polymarket.com/api-reference/relayer/check-if-a-safe-is-deployed)
