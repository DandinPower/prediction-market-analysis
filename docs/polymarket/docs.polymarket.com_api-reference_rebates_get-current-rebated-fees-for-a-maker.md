---
url: "https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker"
title: "Get current rebated fees for a maker - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker#content-area)
...
[​](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker#parameter-date)
...
[​](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker#parameter-maker-address)
...
[​](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker#response-items-date)
...
[​](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker#response-items-condition-id)
...
[​](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker#response-items-asset-address)
...
[​](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker#response-items-maker-address)
...
[​](https://docs.polymarket.com/api-reference/rebates/get-current-rebated-fees-for-a-maker#response-items-rebated-fees-usdc)
...
\\
Previous](https://docs.polymarket.com/api-reference/markets/get-sampling-simplified-markets) [Get current active rewards configurations\\
\\
Next](https://docs.polymarket.com/api-reference/rewards/get-current-active-rewards-configurations)
