...
title: "Get positions for a market - Polymarket Documentation"
---
...
\\
Previous](https://docs.polymarket.com/api-reference/misc/get-total-markets-a-user-has-traded) [Download an accounting snapshot (ZIP of CSVs)\\
\\
