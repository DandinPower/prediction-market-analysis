...
\\
Previous](https://docs.polymarket.com/api-reference/rewards/get-user-earnings-and-markets-configuration) [Get current positions for a user\\
\\
Next](https://docs.polymarket.com/api-reference/core/get-current-positions-for-a-user)
