...
title: "Clients & SDKs - Polymarket Documentation"
---

[Skip to main content](https://docs.polymarket.com/api-reference/clients-sdks#content-area)
...
- [Installation](https://docs.polymarket.com/api-reference/clients-sdks#installation)
- [Quick Example](https://docs.polymarket.com/api-reference/clients-sdks#quick-example)
- [Source Code](https://docs.polymarket.com/api-reference/clients-sdks#source-code)
- [Builder SDKs](https://docs.polymarket.com/api-reference/clients-sdks#builder-sdks)
- [Relayer SDK](https://docs.polymarket.com/api-reference/clients-sdks#relayer-sdk)
- [Next Steps](https://docs.polymarket.com/api-reference/clients-sdks#next-steps)
...
## [​](https://docs.polymarket.com/api-reference/clients-sdks\#installation)  Installation
...
## [​](https://docs.polymarket.com/api-reference/clients-sdks\#quick-example)  Quick Example
...
## [​](https://docs.polymarket.com/api-reference/clients-sdks\#source-code)  Source Code
...
## [​](https://docs.polymarket.com/api-reference/clients-sdks\#builder-sdks)  Builder SDKs

If you’re building an app through the [Builder Program](https://docs.polymarket.com/builders/overview), additional signing SDKs are available:
...
See [Order Attribution](https://docs.polymarket.com/trading/orders/attribution) for usage details.

## [​](https://docs.polymarket.com/api-reference/clients-sdks\#relayer-sdk)  Relayer SDK

For [gasless transactions](https://docs.polymarket.com/trading/gasless) using proxy wallets, the relayer client handles submitting transactions through Polymarket’s relayer:
...
## [​](https://docs.polymarket.com/api-reference/clients-sdks\#next-steps)  Next Steps

[**Quickstart** \\
\\
Set up your client and place your first order.](https://docs.polymarket.com/quickstart)

[**Authentication** \\
\\
Understand L1/L2 auth and API credentials.](https://docs.polymarket.com/api-reference/authentication)
...
[Rate Limits\\
\\
Previous](https://docs.polymarket.com/api-reference/rate-limits) [Geographic Restrictions\\
\\
Next](https://docs.polymarket.com/api-reference/geoblock)
