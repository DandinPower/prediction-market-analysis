...
Token-based matching & Parse each market's YES and NO token IDs, build a lookup table, and stream all trade CSV rows into the correct market side & \texttt{datasets/mapped\_markets/\textless{}market\_id\textgreater{}/metadata.json}, \texttt{yes.csv}, and \texttt{no.csv} \\
